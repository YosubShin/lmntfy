...
module.exports = function() {
    ...
    // var triggerDaemon = require('child_process').spawn('/usr/local/bin/node', ['/Users/Daniel/repos/nodejs/lmntfy/triggers.daemon.js']);
    // triggerDaemon.stdout.on('data', function (data) {
    //     console.log('[TriggerDaemon stdout] %s', data);
    // });
    // triggerDaemon.stderr.on('data', function (data) {
    //     console.log('[TriggerDaemon stderr] %s', data);
    // });
};
